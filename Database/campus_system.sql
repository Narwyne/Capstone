...
CREATE TABLE `locations` (
  ...
  `branch` varchar(100) NOT NULL DEFAULT 'Main Campus',
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  `sort_order` int(11) NOT NULL DEFAULT 0,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `locations` (`id`, `name`, `branch`, `is_active`, `sort_order`, `created_at`) VALUES
(1, 'engineering', 'ACLC Real', 1, 1, '2026-09-16 10:45:33'),
(2, 'admin', 'ACLC Real', 1, 2, '2026-09-16 10:45:33'),
(3, 'library', 'ACLC Real', 1, 3, '2026-09-16 10:45:33'),
(5, 'gymnasium', 'ACLC Real', 1, 5, '2026-09-16 10:45:33'),
(6, 'parking', 'ACLC Real', 1, 6, '2026-09-16 10:45:33'),
(7, 'entrance', 'ACLC Real', 1, 7, '2026-09-16 10:45:33'),
(8, 'laboratory', 'ACLC Real', 1, 8, '2026-09-16 10:45:33'),
(9, 'clinic', 'ACLC Real', 1, 9, '2026-09-16 10:45:33'),
(10, 'comfort_room', 'ACLC Real', 1, 10, '2026-09-16 10:45:33'),
(11, 'grounds', 'ACLC Real', 1, 11, '2026-09-16 10:45:33'),
(12, 'other', 'ACLC Real', 1, 99, '2026-09-16 10:45:33'),
(13, 'canteen', 'ACLC Fatima', 1, 0, '2026-09-22 17:51:19');
